<%@ Page Title="" Language="C#" MasterPageFile="~/Panel/main/Panel.master" AutoEventWireup="true" CodeFile="slider_ekle.aspx.cs" Inherits="Panel_slider_yonetimi_slider_ekle" %>
    ...
    <div id="rightContent">
        ...
        <div class="formsatir">
            ...
            <div class="txtarea">
                ...
                (*)
                <asp:RequiredFieldValidator ID="kontrol_slideradi" runat="server" ControlToValidate="txt_slideradi" SetFocusOnError="true" ErrorMessage="Slider adı boş geçilemez..." ValidationGroup="slider_ekle"></asp:RequiredFieldValidator>
        ...
        <div class="formsatir">
            ...
            <div class="CKEarea">
                <CKEditor:CKEditorControl ID="CKEditor_aciklama" runat="server"></CKEditor:CKEditorControl>
            </div>
        </div>

        <div class="formsatir">
            <div class="butonarea">
                <asp:Button ID="buton_kaydet" runat="server" Text="Kaydet" CssClass="button" OnClick="Kaydet_Click" ValidationGroup="slider_ekle" />
            </div>
        </div>
