<%@ Page Title="" Language="C#" MasterPageFile="~/Panel/main/Panel.master" AutoEventWireup="true" CodeFile="tema_resim_duzenle.aspx.cs" Inherits="tema_yonetimi_tema_resim_duzenle" %>
    ...
    <div id="rightContent">
        ...
        <asp:Panel ID="panel_icon" runat="server">
            <div class="formsatir">
                ...
                <div class="fileuploadarea">
                    <asp:Image ID="theme_image" runat="server" Width="75px" />
                </div>
            </div>
        </asp:Panel>
        ...
        <div class="formsatir">
            ...
            <div class="butonarea">
                <asp:Button ID="buton_guncelle" runat="server" Text="Güncelle" CssClass="button" OnClick="buton_guncelle_Click" ValidationGroup="icerik"/>
            </div>
