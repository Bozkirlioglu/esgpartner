<%@ Page Title="" Language="C#" MasterPageFile="~/Panel/main/Panel.master" AutoEventWireup="true" CodeFile="icerik_duzenle.aspx.cs" Inherits="icerik_duzenle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="rightContent">
        ...
        <div class="formsatir">
            <div class="baslik">İçerik Adı:</div>
            <div class="txtarea">
                <asp:TextBox ID="txt_icerikadi" runat="server" MaxLength="100" CssClass="txt"></asp:TextBox>
                (*)
                <asp:RequiredFieldValidator ID="kontrol_icerikadi" runat="server" ControlToValidate="txt_icerikadi" SetFocusOnError="true" ErrorMessage="İçerik adı boş geçilemez..." ValidationGroup="slider_guncelle"></asp:RequiredFieldValidator>
        ...
        <div class="formsatir">
            ...
            <div class="dropdownarea">
                <asp:DropDownList ID="DropDownList_icerikkategori" runat="server" CssClass="dropdown"></asp:DropDownList>
            </div>
        </div>
        ...
        <asp:Panel ID="panel_icon" runat="server">
            <div class="formsatir">
                ...
                <div class="fileuploadarea">
                    <asp:Image ID="icerik_image" runat="server" Width="75px" />
                </div>
            </div>
        </asp:Panel>

        <div class="formsatir">
            <div class="CKEbaslik">İçerik Açıklaması:</div>
            <div class="CKEarea">
