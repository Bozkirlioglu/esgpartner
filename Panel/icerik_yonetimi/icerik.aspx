<%@ Page Title="" Language="C#" MasterPageFile="~/Panel/main/Panel.master" AutoEventWireup="true" CodeFile="icerik.aspx.cs" Inherits="icerikyonetimi_icerik" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="rightContent">
        ...
        <h3>İçerik Kategorisi Seçiniz <span class="list-description"> * Listelemek istediğiniz içerik kategorisini seçiniz.</span></h3>
            ...
            <asp:Repeater ID="rpliste" runat="server" OnItemCommand="rpliste_ItemCommand">
                    ...
                    <table id="dtable" class="display" style="width: 100%">
                        <thead>
                            ...
                            <tr>
                                ...
                                <th style="width: 13%;">İçerik Resim</th>
                                <th style="width: 25%">İçerik Adı</th>
                                <th style="width: 20%">İçerik Kategori</th>
                                <th style="width: 15%">İçerik Durum</th>
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <img height="36" src="icerik_resim/thumb1/<%#Eval("icerik_resim") %>" /></td>
                        <td><%# Eval("icerik_adi") %></td>
                        <td><%# Eval("kategori_adi") %></td>
                        <td><%# Eval("icerik_durum").ToString() == "True" ? "<img src='../img/true.png' />" : "<img src='../img/false.png' />" %></td>
                        <td>
                            <asp:Button runat="server" CssClass="linkbdataedit" CommandName="Guncelle" CommandArgument='<%#Eval("icerik_id") %>'></asp:Button>
                            <asp:Button ID="sil" runat="server" CssClass="linkbdatadelete" CommandName="Delete" CommandArgument='<%#Eval("icerik_id") %>' OnClientClick="return confirmCheckIn(this);"></asp:Button>
                        </td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
