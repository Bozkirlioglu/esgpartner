<%@ Page Title="" Language="C#" MasterPageFile="~/Panel/main/Panel.master" AutoEventWireup="true" CodeFile="kategori_duzenle.aspx.cs" Inherits="kategori_duzenle" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            if ($('#ContentPlaceHolder1_panel_hatali').hasClass('aktif')) {
                ...
                setTimeout(function () {
                    window.location = "../kategori_yonetimi/kategori_duzenle.aspx";
                }, 7000);
            }
    ...
    <div id="rightContent">
        ...
        <asp:Panel ID="panel_icon" runat="server">
            <div class="formsatir">
                ...
                <div class="fileuploadarea">
                    <asp:Image ID="kategori_image" runat="server" Width="75px" />
                </div>
            </div>
        </asp:Panel>

        <div class="formsatir">
            <div class="CKEbaslik">Kategori Açıklaması:</div>
            <div class="CKEarea">
