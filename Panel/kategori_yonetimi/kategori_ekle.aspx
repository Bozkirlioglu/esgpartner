<%@ Page Title="" Language="C#" MasterPageFile="~/Panel/main/Panel.master" AutoEventWireup="true" CodeFile="kategori_ekle.aspx.cs" Inherits="Panel_kategori_yonetimi_kategori_ekle" %>
    ...
    <div id="rightContent">
        ...
        <div class="formsatir">
            ...
            <div class="dropdownarea">
                <asp:DropDownList ID="DropDownList_kategoritype" runat="server" CssClass="dropdown"></asp:DropDownList>
            </div>
