<%@ Page Title="" Language="C#" MasterPageFile="~/Panel/main/Panel.master" AutoEventWireup="true" CodeFile="ikform.aspx.cs" Inherits="formyonetimi_ikform" %>
    ...
    <script type="text/javascript" charset="utf-8">
        ...
        $(document).ready(function () {
            ...
            if ($('#ContentPlaceHolder1_panel_basarili').hasClass('aktif')) {
                ...
                setTimeout(function () {
                    window.location = "../form_yonetimi/ikform.aspx";
                }, 5000);
            }
            ...
            <asp:Repeater ID="rpliste" runat="server" OnItemCommand="rpliste_ItemCommand">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td><%#Eval("ik_adsoyad") %></td>
                        <td><%# Eval("ik_mail") %></td>
                        <td><%# Eval("ik_tel") %></td>
                        <td><%# Eval("ik_kayittarih") %></td>
                        <td><%# Eval("ik_okundu").ToString() == "True" ? "<img src='../img/true.png' />" : "<img src='../img/false.png' />" %></td>
                        <td>
                            <asp:Button runat="server" CssClass="linkbdataview" CommandName="Goruntule" CommandArgument='<%#Eval("ik_id") %>' FormTaget="_blank"></asp:Button>
                            <asp:Button ID="sil" runat="server" CssClass="linkbdatadelete" CommandName="Delete" CommandArgument='<%#Eval("ik_id") %>' OnClientClick="return confirmCheckIn(this);"></asp:Button>
                        </td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
